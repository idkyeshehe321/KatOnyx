...
local function NTENS_fake_script() -- TextButton.ClickHandler 
...
coroutine.wrap(NTENS_fake_script)()
local function CIVXA_fake_script() -- X.ClickHandler 
...
coroutine.wrap(CIVXA_fake_script)()
local function MCEEYD_fake_script() -- ImageLabel.PFPHandler 
...
coroutine.wrap(MCEEYD_fake_script)()
local function MVGWM_fake_script() -- Welcome.WelcomeClient 
...
coroutine.wrap(MVGWM_fake_script)()
local function UWAW_fake_script() -- RemoteSearch.RemoteSearch 
	local script = Instance.new('LocalScript', RemoteSearch)

	script.Parent.Activated:Connect(function()
		---)
		if not game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("EventFinder") then
			...
			local function HLNR_fake_script() -- Settings.SettingsHandler 
				...
				uistroke2.Parent = Stats
				uistroke2.Thickness = 3
				uistroke3.Parent = Stats:FindFirstChild("Frame")
				uistroke3.Thickness = 3
				uistroke4.Parent = statsframe.Settings:FindFirstChild("SettingsFrame")
				uistroke4.Thickness = 3
				---)
			end
			coroutine.wrap(HLNR_fake_script)()
		else
			game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("EventFinder"):Destroy()
			local EventFinder = Instance.new("ScreenGui")
			local Tab = Instance.new("Frame")
			local UICorner = Instance.new("UICorner")
			local X = Instance.new("TextButton")
...
coroutine.wrap(UWAW_fake_script)()
local function CNDOP_fake_script() -- WorldEdit.WorldEdit 
	local script = Instance.new('LocalScript', WorldEdit)

	script.Parent.Activated:Connect(function()
		---)
		if not game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("OnyxWorldEdit") then
			...
			game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("OnyxWorldEdit"):Destroy()
			local OnyxWorldEdit = Instance.new("ScreenGui")
			local Tab = Instance.new("Frame")
			local UICorner = Instance.new("UICorner")
			local DecendentsScroll = Instance.new("ScrollingFrame")
	...
	drag.Parent = Tag
	---)
	uistroke1.Parent = Tag
	uistroke1.Thickness = 3
	uistroke2.Parent = MainUI
	uistroke2.Thickness = 3
	uistroke3.Parent = ScrollingFrame
	uistroke3.Thickness = 3
	uistroke4.Parent = ImageLabel
	uistroke4.Thickness = 3
	---)
end
coroutine.wrap(CNDOP_fake_script)()
